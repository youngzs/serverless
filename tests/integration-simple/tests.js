...
const getTmpDirPath = require('../utils/index').getTmpDirPath;
const replaceTextInFile = require('../utils/index').replaceTextInFile;
const getServiceName = require('../utils/index').getServiceName;
const region = require('../utils/index').testRegion;
